# the-smart-receipt-scanner

A receipt-scanning app for freelancers that uses AI to extract vendor, date, and amount from a photo and auto-categorizes the expense, with a Stripe-gated Pro tier for unlimited scans.
